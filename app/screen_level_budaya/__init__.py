...
class BudayaScreen(WithDefaultBG):
    ...
    def setup_ui(self):
        ...
        ceria_button = CustomButton(
            app=self.app,
            size_hint=(0.9, 0.2),
            destination="budaya_ceria",
            source="assets/img/select_level/budaya/1.png",
        ...
        seru_button = CustomButton(
            app=self.app,
            size_hint=(0.9, 0.2),
            destination="budaya_seru",
            source="assets/img/select_level/budaya/2.png",
